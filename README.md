...
[![Build Size](https://img.shields.io/bundlephobia/minzip/reasy-state@latest?label=bundle%20size&style=flat&colorA=0066CC&colorB=FFCC00)](https://bundlephobia.com/result?p=reasy-state)
